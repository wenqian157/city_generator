...
engine.rules.append([{"select":"construct_side", "ratio": 0.05}, {"subd": "face_extrude_tapered", "arg": [5, 0]}])
engine.rules.append([{"select":"wall", "ratio": 1.0}, {"subd": "face_split_cell", "arg": [3, 3]}])
engine.rules.append([{"select":"panel", "ratio": 0.5}, {"subd": "face_extrude_tapered", "arg": [0, 0.3]}])


engine.subdivide_block(3)
engine.subdivide_building(18)
engine.subdivide_facade(2)

mesh_city = engine.mesh
print(len(mesh_city.faces))
mola.export_obj(mesh_city, "my_city4.obj")
